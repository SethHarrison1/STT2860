...
\addcontentsline{toc}{subsection}{Out-of-sample RMSE for linear regression}
...
\addcontentsline{toc}{subsection}{Comparing out-of-sample RMSE to in-sample RMSE}
...
\addcontentsline{toc}{subsection}{Class probabilities and predictions video}
...
\addcontentsline{toc}{subsection}{\texttt{glmnet} with custom tuning grid video}
...
\addcontentsline{toc}{subsection}{Use KNN imputation video}
...
\begin{center}\includegraphics{MachineLearningToolboxSC_files/figure-latex/unnamed-chunk-92-1} \end{center}
...
\begin{center}\includegraphics{MachineLearningToolboxSC_files/figure-latex/unnamed-chunk-93-1} \end{center}
...
\addcontentsline{toc}{subsection}{Handling low-information predictors video}
...
\addcontentsline{toc}{subsection}{Why remove near zero variance predictors?}
...
\addcontentsline{toc}{subsection}{Principle components analysis (PCA) video}
...
\addcontentsline{toc}{subsection}{Reintroducing random forest video}
...
\addcontentsline{toc}{subsection}{Comparing models video}
...
\addcontentsline{toc}{subsection}{More on resamples video}
...
\begin{center}\includegraphics{MachineLearningToolboxSC_files/figure-latex/unnamed-chunk-117-1} \end{center}
...
\begin{center}\includegraphics{MachineLearningToolboxSC_files/figure-latex/unnamed-chunk-118-1} \end{center}
...
\addcontentsline{toc}{subsection}{Summary video}
