...
<iframe src="https://drive.google.com/file/d/1FfBjEI_xsDtsvjtvvjmzvVgrp-HF_dQb/preview" width="740" height="420"></iframe>
...
<iframe src="https://drive.google.com/file/d/13mmtz60ReHMKvUJ88K82-8APoNXLAKdl/preview" width="740" height="420"></iframe>
...
```{r}
# include interaction
lm(total_pr ~ cond + duration + cond:duration, data = mario_kart)
```
...
<iframe src="https://drive.google.com/file/d/1-ddeEFE2uwO2DspUisk6Y2lU8KgTAdyu/preview" width="740" height="420"></iframe>
...
```{r, label = "slrP1", fig.cap = "`total_pr` versus `duration`"}
