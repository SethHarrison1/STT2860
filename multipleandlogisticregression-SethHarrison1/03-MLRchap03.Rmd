...
<iframe src="https://drive.google.com/file/d/1mSBKm8mrEEVDxppYdLSJlUUtl5n8_L8o/preview" width="740" height="420"></iframe>
________________
...
<iframe src="https://drive.google.com/file/d/1fq_2MPf5Ctb8WyJEHNATYvY0tYCCWYFL/preview" width="740" height="420"></iframe>
...
<iframe src="https://drive.google.com/file/d/10nAYTChTPofI3iKtaUUx9rS8xMvU28JN/preview" width="740" height="420"></iframe>
___________________
...
```{r}
modI <- lm(total_pr ~ duration + start_pr + cond, data = mario_kart)
summary(modI)$coef
...
<iframe src="https://drive.google.com/file/d/1nXPcl-9qDT8L_8QsBV4_9OjGJbqW93N8/preview" width="740" height="420"></iframe>
__________
...
```{r}
modJ <- lm(total_pr ~ duration + start_pr + cond + wheels + n_bids, 
    data = mario_kart)
modJ
```
