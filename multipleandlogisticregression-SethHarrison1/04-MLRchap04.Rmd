...
<iframe src="https://drive.google.com/file/d/18R98VwkUBdvYbi8mMRnajVnz3qhkMulk/preview" width="740" height="420"></iframe>
...
<iframe src="https://drive.google.com/file/d/1N8htp_XH7rwmRE_V5Y5ibRNE77R7Ss0k/preview" width="740" height="420"></iframe>
...
<iframe src="https://drive.google.com/file/d/1y4uxsSJZIY09syh_89Zz9urK-8Eq03p0/preview" width="740" height="420"></iframe>
...
$$\text{odds}(\widehat{y})=\frac{\widehat{y}}{1 - \hat{y}}=\exp(\widehat{\beta}_0 + \widehat{\beta}_1 \cdot x)$$
...
Donald’s GPA is 2.9, and thus the model predicts that the probability of him getting into medical school is `r round(predict(mod, newdata = data.frame(GPA = 2.9), type = "response") * 100, 2)`%. The odds of Donald getting into medical school are 0.0337, or—phrased in gambling terms—29.6:1. If Donald hacks the school’s registrar and changes his GPA to 3.9, then which of the following statements is **FALSE**:
...
<iframe src="https://drive.google.com/file/d/1kK5DBvotmbvgXex9WP5tmKfF2QllTVgj/preview" width="740" height="420"></iframe>
