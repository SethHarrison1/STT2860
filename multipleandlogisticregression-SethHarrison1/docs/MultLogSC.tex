...
\addcontentsline{toc}{subsection}{What if you have two groups?}
...
\StringTok{  }\KeywordTok{filter}\NormalTok{(total_pr }\OperatorTok{<}\StringTok{ }\DecValTok{100}\NormalTok{)}
...
\addcontentsline{toc}{subsection}{Visualizing parallel slopes models}
...
\begin{center}\includegraphics{MultLogSC_files/figure-latex/unnamed-chunk-8-1} \end{center}
...
\addcontentsline{toc}{subsection}{Interpreting parallel slopes coefficients}
...
\addcontentsline{toc}{subsection}{Three ways to describe a model}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{babies <-}\StringTok{ }\NormalTok{babies }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{smoke =} \KeywordTok{factor}\NormalTok{(smoke))}
\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ babies, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ gestation, }\DataTypeTok{y =}\NormalTok{ bwt, }\DataTypeTok{color =}\NormalTok{ smoke)) }\OperatorTok{+}\StringTok{ }
...
\begin{center}\includegraphics{MultLogSC_files/figure-latex/unnamed-chunk-13-1} \end{center}
...
\addcontentsline{toc}{subsection}{Model fit, residuals, and prediction}
...
\addcontentsline{toc}{subsection}{Understanding interaction}
...
\begin{center}\includegraphics{MultLogSC_files/figure-latex/unnamed-chunk-23-1} \end{center}
...
\begin{center}\includegraphics{MultLogSC_files/figure-latex/unnamed-chunk-26-1} \end{center}
...
\addcontentsline{toc}{subsection}{Adding a numerical explanatory variable}
...
\NormalTok{p <-}\StringTok{ }\KeywordTok{plot_ly}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ mario_kart, }\DataTypeTok{z =} \OperatorTok{~}\NormalTok{total_pr, }\DataTypeTok{x =} \OperatorTok{~}\NormalTok{duration, }\DataTypeTok{y =} \OperatorTok{~}\NormalTok{start_pr, }\DataTypeTok{opacity =} \FloatTok{0.6}\NormalTok{) }\OperatorTok{%>%}
...
\hypertarget{conditional-interpretation-of-coefficients}{%
\subsection*{Conditional interpretation of coefficients}\label{conditional-interpretation-of-coefficients}}
\addcontentsline{toc}{subsection}{Conditional interpretation of coefficients}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\hypertarget{coefficient-magnitude}{%
...
\addcontentsline{toc}{subsection}{Adding a third (categorical) variable}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{modI <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(total_pr }\OperatorTok{~}\StringTok{ }\NormalTok{duration }\OperatorTok{+}\StringTok{ }\NormalTok{start_pr }\OperatorTok{+}\StringTok{ }\NormalTok{cond, }\DataTypeTok{data =}\NormalTok{ mario_kart)}
...
\addcontentsline{toc}{subsection}{Higher dimensions}
...
\addcontentsline{toc}{subsection}{Interpretation of coefficient in a big model}
...
\addcontentsline{toc}{section}{What is logistic regression?}
...
\begin{center}\includegraphics{MultLogSC_files/figure-latex/unnamed-chunk-43-1} \end{center}
...
\begin{center}\includegraphics{MultLogSC_files/figure-latex/unnamed-chunk-46-1} \end{center}
...
\begin{center}\includegraphics{MultLogSC_files/figure-latex/unnamed-chunk-47-1} \end{center}
...
\addcontentsline{toc}{subsection}{Visualizing logistic regression}
...
\begin{center}\includegraphics{MultLogSC_files/figure-latex/unnamed-chunk-50-1} \end{center}
...
\begin{center}\includegraphics{MultLogSC_files/figure-latex/unnamed-chunk-64-1} \end{center}
...
\addcontentsline{toc}{subsection}{Using a logistic model}
...
\addcontentsline{toc}{subsection}{Italian restaurants in NYC}
...
\begin{center}\includegraphics{MultLogSC_files/figure-latex/unnamed-chunk-70-1} \end{center}
...
\begin{center}\includegraphics{MultLogSC_files/figure-latex/unnamed-chunk-71-1} \end{center}
...
\addcontentsline{toc}{subsection}{Incorporating another variable}
...
\addcontentsline{toc}{subsection}{Interpretation of location coefficient}
